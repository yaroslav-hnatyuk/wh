 ...
 */
class Version20180624020744 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        $this->addSql("
            CREATE TRIGGER `dish_BEFORE_UPDATE` BEFORE UPDATE ON `dish` FOR EACH ROW
            BEGIN
    ...
    {
        $this->addSql("DROP TRIGGER IF EXISTS `dish_BEFORE_UPDATE`");
    }
}
